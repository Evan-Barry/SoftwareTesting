...
public class RobotMockTest {
    ...
    public void testEngineer() throws Exception
    {
        ...
        PowerMock.expectNew(Engineer.class, "Mark Brown", 123).andReturn(mockEngineer);

        expect(mockEngineer.getContactNo()).andReturn(123);

        PowerMock.replay(mockEngineer, Engineer.class);

        int expResult = 123;
        int result = Buddy.recordEngineer("Mark Brown", 123);
